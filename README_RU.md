...
7. При необходимости нажмите **Выбрать…** рядом с полем emoji status и выполните подсказку в Telegram.
8. Проверьте остальные параметры, выберите режим аудио и настройки уведомлений, затем нажмите **Сохранить**.
...
| Emoji status при nowplaying | Необязательный ID custom emoji для Telegram Premium; очистите поле, чтобы отключить функцию |
